...
def snowflake_user_pull(ms_user_list):
	...
	try:
	    ...
	    for row in df.itertuples(name="ADPUserList"):
	        ...
	        if employee_email:
	        	return_dict = return_msuser_dict(employee_email.casefold(), employee_id, employee_full_name, employee_preferred_name, ms_user_list)
	        	...
	        	return_dict = return_msuser_dict(employee_email, employee_id, employee_full_name, employee_preferred_name, ms_user_list)
	        else:
	        	return_dict = return_msuser_dict(employee_email, employee_id, employee_full_name, employee_preferred_name, ms_user_list)
...
>>>>>>> e53e8a26a301f36aa3154991808d3a19987a23cd
